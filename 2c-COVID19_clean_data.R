...
## Side Note: entries with bad Locale/Combined_Key: "Weber,Utah,US", "District of Columbia,District of Columbia,US"
...
locales_without_population <- population_data_US$Locale[which(population_data_US$Population == 0)]


## Remove entries for which the population is equal to zero from population data set
population_data_US <- population_data_US %>%
  filter(Population > 0)
