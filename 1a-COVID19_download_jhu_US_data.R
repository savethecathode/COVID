...
## Data on recoveries in the US is stored on a day-by-day bases (in individual CSV files) by state but not for every state and is not broken down further to the city/town level.
## NOTE: estimate the number of recovery cases based on the recovery time, which is ~2 weeks (WHO)
